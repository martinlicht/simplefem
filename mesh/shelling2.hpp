...
void generate_shellings2(
    ...
    for( int i = 0; i < remaining_nodes.size(); i++ ) 
    {
        ...
        // let us now compute the next vector in the coefficient table
        {
            ...
            Float pullbackfactor = info.C5[current_node][k][form_degree];
            ...
            weight_for_node_2[i] = info.C7[current_node][k][form_degree] * info.C8[current_node][k][form_degree+1]; // TODO: which form degree?
