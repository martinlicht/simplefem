...
MeshSimplicialND::MeshSimplicialND( int outerdim )
:
    Mesh( 1, outerdim ),
...
int MeshSimplicialND::count_edges() const
{
    return counter_edges;
}

int MeshSimplicialND::count_vertices() const
{
...
bool MeshSimplicialND::contains_edge_vertex( int e, int v ) const
{
...
int MeshSimplicialND::indexof_edge_vertex( int e, int v ) const
{
    assert( 0 <= e && e < counter_edges );
    assert( 0 <= v && v < counter_vertices );
...
int MeshSimplicialND::get_edge_vertex( int e, int vi ) const
{
    assert( 0 <= e && e < counter_edges );
    assert( 0 <= vi && vi < 2 );
...
const std::array<int,2> MeshSimplicialND::get_edge_vertices( int e ) const
{
    assert( 0 <= e && e < counter_edges );
...
int MeshSimplicialND::count_vertex_edge_parents( int v ) const
{
  return get_edge_parents_of_vertex( v ).size();
}

int MeshSimplicialND::get_vertex_firstparent_edge( int v ) const
{
  assert( 0 <= v && v < counter_vertices );
  return data_vertex_firstparent_edge[ v ];
}

int MeshSimplicialND::get_vertex_nextparent_edge( int v, int e ) const
{
  assert( 0 <= v && v < counter_vertices );
  assert( 0 <= e && e < counter_edges    );
...
int MeshSimplicialND::get_edge_nextparent_of_vertex( int e, int vi ) const
{
  assert( 0 <= e  && e  < counter_edges    );
  assert( 0 <= vi && vi < 2 );
...
bool MeshSimplicialND::is_edge_vertex_parent( int e, int v ) const
{
  assert( 0 <= v && v < counter_vertices );
  assert( 0 <= e && e < counter_edges    );
  return data_edge_vertices[e][0] == v || data_edge_vertices[e][1] == v;
...
int MeshSimplicialND::indexof_edge_vertex_parent( int e, int v ) const
{
...
std::vector<int> MeshSimplicialND::get_edge_parents_of_vertex( int v ) const
{
  assert( 0 <= v && v < count_vertices() );
...
void MeshSimplicialND::improved_uniformrefinement()
{
    check();
...
FloatVector MeshSimplicialND::get_edge_midpoint    ( int e )
{
    assert( 0 <= e && e < counter_edges );
