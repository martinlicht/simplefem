...
inline MeshSimplicial3D UnitSquare3D()
{
...
inline MeshSimplicial3D LShapedDomain3D()
{
    return MeshSimplicial3D(
      2,
      Coordinates( 2, 8, {
...
inline MeshSimplicial3D SlitDomain3D()
{
    return MeshSimplicial3D(
      3,
      Coordinates( 3, 10, {
...
inline MeshSimplicial3D TetrahedralSurface3D()
{
    return MeshSimplicial3D(
      3,
      Coordinates( 3, 4, {
