...
affix.image         := fem mesh solver dense sparse operators combinatorics utility basic external
...
affix.benchmark     := fem vtk mesh solver dense sparse operators combinatorics utility basic external
