    ...
    for( int l = min_l; l <= max_l; l++ ){
        ...
        for( int r = min_r; r <= max_r; r++ ) 
        {
            ...
            if( do_gradient ) {
                ...
                LOG << "...begin inverse iteration (SCALAR)" << nl;
                ...
                for( int s = 0; s < max_attempts; s++ )
                {
                    ...
                    LOG << "...compute error and residual (SCALAR)" << nl;
                    ...
                    contables_scalar[r-min_r] << PF_estimate_via_shellings[0] * std::sqrt(curratio);
                    contables_scalar[r-min_r] << u_massnorm;
                    contables_scalar[r-min_r] << ucurl_massnorm;
