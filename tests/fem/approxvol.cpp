...
int main()
{
        ...
        
        {
            ...
            for( int l = 0; l <= 2; l++ ){
                ...
                for( int r = 0; r <= 3; r++ ) 
                {
                    SparseMatrix massmatrix = FEECBrokenMassMatrix( M, M.getinnerdimension(), 3, r );
                    
                    SparseMatrix massmatrix_rhs = FEECBrokenMassMatrixRightFactor( M, M.getinnerdimension(), 3, r );
                    ...
                    for( int i = 0; i < experiments_field.size(); i++){
                        ...
                        FloatVector interpol = Interpolation( M, M.getinnerdimension(), 3, r, scalarfield );
