...
int main()
{
        ...
        {
            for( int i = 0; i < experiments_scalar_field.size(); i++ ) 
                assert( errors_scalar[i][l-l_min][r-r_min] < 10e-12 );
            
            for( int i = 0; i < experiments_vector_field.size(); i++ ) 
                assert( errors_vector[i][l-l_min][r-r_min] < 10e-12 );
            
            for( int i = 0; i < experiments_pseudo_field.size(); i++ ) 
                assert( errors_pseudo[i][l-l_min][r-r_min] < 10e-12 );
            
            for( int i = 0; i < experiments_volume_field.size(); i++ )
                assert( errors_volume[i][l-l_min][r-r_min] < 10e-12 );
        }
