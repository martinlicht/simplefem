...
int main()
{
        ...
        if(true)
        {
                ...
                LOG << "Teste generator for empty index map" << nl;
        ...
        if(true)
        {
                ...
                LOG << "Teste generator for all: [1,3] -> [1,3]" << nl;
        ...
        if(true)
        {
                ...
                LOG << "Teste generator for permutations of [1,3]" << nl;
        ...
        if(true)
        {
                ...
                LOG << "Teste generator for sigmas [1,3] -> [2,5]" << nl;
        ...
        if(true)
        {
                ...
                LOG << "Test generator for empty index map" << nl;
        ...
        if(true)
        {
                ...
                LOG << "Test generator for general index mappings" << nl;
        ...
        if(true)
        {
                ...
                LOG << "Test generator for permutations of [1,3]" << nl;
        ...
        if(true)
        {
                ...
                LOG << "Test generator for sigmas [1,3] -> [2,5]" << nl;
