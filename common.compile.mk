...
# Enforce a strict evaluation order, which specifies the semantics 
...
# - use short enums
# - do NOT assume that math is finite
...
# * avoid the procedure linkage table.
ifneq ($(OS),Windows_NT)
...
# Defaulted constructors/assignment operators are deleted if the base has them deleted. 
