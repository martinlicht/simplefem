...
BlockDiagonalOperator::BlockDiagonalOperator( int dimension_out, int dimension_in, std::vector<LinearOperator*> ops )
...
{
    std::clog << "Check Block Diagonal Operator" << std::endl;
